...
?>
  ...
  <body>
    ...
    <div class="container container-form">
      <div class="row">
        <legend>Pengambilan</legend>
        <p>
          <a target="_blank" href="cetak-data-pengambilan.php" class="btn btn-success"><i class="glyphicon glyphicon-print"></i> Cetak</a>
        </p>
        ...
        <div class="table-responsive">
          <table class="table table-condensed table-bordered" id="example2">
            ...
            <tbody>
              ...
              $sql = "SELECT * FROM tb_pengambilan where nis = '" . $_GET['nis'] . "'";
              ...
              ?>
                  <tr>
                    ...
                    <?php if ($_SESSION['level'] == 'Pembina') : ?>
                      <td align="center">
                        <a href="ubah-data-pengambilan.php?id_pengambilan=<?php echo $data['id_pengambilan']; ?>">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true" title="Ubah"></span>
                        </a> ||
                        <a href="hapus-data-pengambilan.php?id_pengambilan=<?php echo $data['id_pengambilan']; ?>">
