...
?>
  ...
  $id_penitipan = htmlentities($_GET['id_penitipan']);
  $sql = "SELECT * FROM tb_penitipan WHERE id_penitipan = '$id_penitipan'";
  ...
  <body>
    ...
    <div class="container container-form">
      <div class="row">
        <div class="span12">
          <legend>Ubah Data Penitipan</legend>
          <form method="POST" action="perbarui-data-penitipan.php">
            <div class="form-group ">
              <div class="input-group">
                <label>Id Penitipan</label>
                <input type="text" name="id_penitipan" value="<?php echo $i['id_penitipan']; ?>" class="form-control" required readonly></input>
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
              ...
              <div class="form-group">
                ...
                <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                  <input class="form-control" type="text" disabled="disabled" value="<?php echo $i['tgl_penitipan']; ?>">
                  <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                  <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                </div>
                <input type="hidden" id="dtp_input2" name="tgl_penitipan" value="2020-01-19">
              </div>

              <input type="submit" class="btn btn-info" name="submit" value="Perbarui">
              <a href="./data-penitipan.php" class="btn btn-info">Batal</a>
          </form><br>
        </div>
      </div>
    </div>
