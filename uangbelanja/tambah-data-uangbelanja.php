...
<html lang="en">
  ...
  <div class="container container-form">
    <div class="row">
      ...
      <legend>Entri Data Uang Belanja</legend>
        <form method="POST" action="simpan-data-uangbelanja.php">
          <div class="form-group ">
            <div class="input-group">
            <label>Id_uangbelanja</label>
            <input type="text" name="id_uangbelanja" class="form-control" required></input>
            </div>
          </div>
          <div class="form-group">
                <div class="input-group">
          ...
          <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" name="Ket" class="form-control" id="Ket" required></input>
              </div>
            </div>
          </div>
          <div class="form-group">
