...
<html lang="en">
  ...
  <div class="row">
  <legend>Manajemen Data User Login</legend>
  <p><a href="tambah-data-user.php"><button type="button" class="btn btn-primary">Tambah Data</button></a></p>
  <div class="table-responsive">
  <table class="table table-condensed table-bordered" id="table">
      <thead>
      <tr>
        <th>No.</th>
        <th>ID User (Id_pembina,Id_walisantri,Id_admin)</th>
        <th>Username</th>
        <th>Password</th>
        <th>Level</th>
        <th>Aksi</th>
    ...
    ?>
        ...
        <td align="center">
        <a href="ubah-data-user.php?id=<?php echo $data['id_user'];?>">
        <span class="glyphicon glyphicon-edit" aria-hidden="true" title="Ubah"></span>
        </a> ||
        <a href="hapus-data-user.php?id=<?php echo $data['id_user'];?>">
