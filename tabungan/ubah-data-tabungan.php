...
?>
  ...
  $Idtabungan = htmlentities($_GET['id_tabungan']);
  $sql = "SELECT * FROM tb_tabungan WHERE id_tabungan = '$Idtabungan'";
  ...
  <body>
    ...
    <div class="container container-form">
      <div class="row">
        <div class="span12">
          <legend>Ubah Data Tabungan</legend>
          <form method="POST" action="perbarui-data-tabungan.php">
            <div class="form-group ">
              <div class="input-group">
                <label>Id_Tabungan</label>
                <input type="text" name="id_tabungan" value="<?php echo $i['id_tabungan']; ?>" class="form-control" required readonly></input>
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
            ...
            <div class="form-group">
              ...
              <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                <input class="form-control" type="text" disabled="disabled" value="<?php echo $i['tgl_tabungan']; ?>">
                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
              </div>
              <input type="hidden" id="dtp_input2" name="tgl_tabungan" value="2020-01-19">
            </div>

            <input type="submit" class="btn btn-info" name="submit" value="Perbarui">
            <a href="./lap-tabungan.php" class="btn btn-info">Batal</a>
          </form><br>
        </div>
      </div>
    </div>
