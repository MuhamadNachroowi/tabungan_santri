    ...
    <div class="container container-form">
      <div class="row">
        ...
        <?php if ($_SESSION['level'] == 'Pembina') : ?>
          ...
          <a href="tambah-data-pengambilan.php"><button type="button" class="btn btn-primary">Tambah Data</button></a>
        <?php endif; ?>
