...
?>
  ...
  <body>
    ...
    <div class="container container-form">
      <div class="row">
        <legend>Tabungan</legend>
        <p>
          <a target="_blank" href="cetak-data-tabungan.php" class="btn btn-success"><i class="glyphicon glyphicon-print"></i> Cetak</a>
        </p>
        ...
        <div class="table-responsive">
          <table class="table table-condensed table-bordered" id="example2">
            ...
            <tbody>
              ...
              $sql = "SELECT * FROM tb_tabungan where nis = '" . $_GET['nis'] . "'";
              ...
              ?>
                  <tr>
                    ...
                    <td><?php echo $data['tgl_tabungan']; ?></td>
                    <?php if ($_SESSION['level'] == 'Pembina') : ?>
                      <td align="center">
                        <a href="ubah-data-tabungan.php?id_tabungan=<?php echo $data['id_tabungan']; ?>">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true" title="Ubah"></span>
                        </a> ||
                        <a href="hapus-data-tabungan.php?id_tabungan=<?php echo $data['id_tabungan']; ?>">
