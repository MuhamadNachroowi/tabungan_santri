...
<body onload="window.print();">
  ...
  include '../lib/koneksi.php';
         ...
         $sql3 = "SELECT * FROM tb_kamar WHERE KodeKmr='$_GET[kmr]'";
        $result3 = mysqli_query($conn, $sql3);
        $km = mysqli_fetch_array($result3);
  ?>
  <div style="width:100%;float: left;">
 <div style="border-bottom: 2px solid #555;padding:10px 0;margin-bottom: 20px;"></div>
 <center>LAPORAN DATA SANTRI KAMAR<b><?php echo strtoupper($km['NamaKmr']); ?></b></center>
