      ...
      <div class="row">
        <div class="span12">
          <div class="input-group">
            <legend>Entri Data Penitipan</legend>
            <form method="POST" action="simpan-data-penitipan.php">
              <div class="form-group ">
                <div class="input-group">
                  <label>id_penitipan</label>
                  <input type="text" name="id_penitipan" class="form-control" required></input>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
          ...
          <a href="./lap-penitipan.php" class="btn btn-info">Batal</a>
          </form>
        </div>
      </div>
    </div>
