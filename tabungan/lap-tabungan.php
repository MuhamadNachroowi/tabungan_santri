      ...
      <div class="row">
        ...
        <p>
          <?php if ($_SESSION['level'] == 'Pembina') : ?>
            ...
            <a href="tambah-data-tabungan.php"><button type="button" class="btn btn-primary">Tambah Data</button></a>
          <?php endif; ?>
        </p>
